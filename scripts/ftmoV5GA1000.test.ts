/**
 * V5 Genetic Algorithm — 1000 generations, anti-overfit edition.
 *
...
const LOG_FILE = `${LOG_DIR}/V5_GA1000_${STAMP}.log`;
const WINNER_FILE = `${LOG_DIR}/V5_GA1000_WINNER_${STAMP}.json`;
...
describe(
  "V5 Genetic Algorithm — 1000 generations + slice rotation",
  { timeout: 24 * 3600_000 },
  () => {
