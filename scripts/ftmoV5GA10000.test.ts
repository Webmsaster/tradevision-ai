/**
 * V5 Genetic Algorithm — 10000 generations, anti-overfit edition.
 *
...
const LOG_FILE = `${LOG_DIR}/V5_GA10000_${STAMP}.log`;
const WINNER_FILE = `${LOG_DIR}/V5_GA10000_WINNER_${STAMP}.json`;
...
describe(
  "V5 Genetic Algorithm — 10000 generations + slice rotation",
  { timeout: 24 * 3600_000 },
  () => {
