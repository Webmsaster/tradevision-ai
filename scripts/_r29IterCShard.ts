...
const iterCBarMinutes = (cfg as { barMinutes?: number }).barMinutes;
if (iterCBarMinutes !== undefined && iterCBarMinutes !== 30) {
  throw new Error(
    `_r29IterCShard winBars hardcoded *48 (30m); cfg.barMinutes=${iterCBarMinutes}`,
  );
}
