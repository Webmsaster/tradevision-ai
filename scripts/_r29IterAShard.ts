...
const iterABarMinutes = (cfg as { barMinutes?: number }).barMinutes;
if (iterABarMinutes !== undefined && iterABarMinutes !== 30) {
  throw new Error(
    `_r29IterAShard winBars hardcoded *48 (30m); cfg.barMinutes=${iterABarMinutes}`,
  );
}
