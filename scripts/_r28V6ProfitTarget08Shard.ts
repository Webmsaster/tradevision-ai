...
const pt08BarMinutes = (cfg as { barMinutes?: number }).barMinutes;
if (pt08BarMinutes !== undefined && pt08BarMinutes !== 30) {
  throw new Error(
    `_r28V6ProfitTarget08Shard winBars hardcoded *48 (30m); cfg.barMinutes=${pt08BarMinutes}`,
  );
}
