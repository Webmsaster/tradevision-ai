...
const throttleBarMinutes = (cfg as { barMinutes?: number }).barMinutes;
if (throttleBarMinutes !== undefined && throttleBarMinutes !== 30) {
  throw new Error(
    `_r28V6IntradayThrottleShard winBars hardcoded *48 (30m); cfg.barMinutes=${throttleBarMinutes}`,
  );
}
