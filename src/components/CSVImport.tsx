    ...
    try {
      ...
      const message =
        err instanceof Error
          ? err.message
          : "Failed to map CSV data to trades.";
      setError(message);
    }
  }
      ...
      {step === 1 && (
        <div className="csv-step-content">
          ...
          >
            ...
            <div className="csv-dropzone-hint">or click to browse files</div>
          </div>
        ...
        <div className="csv-step-content">
          ...
          >
            ...
            {skippedRows > 0 && (
              <span style={{ color: "var(--text-warning, #f59e0b)" }}>
                {" "}
                &middot; {skippedRows} row{skippedRows !== 1 ? "s" : ""} skipped
                due to missing data
              </span>
            )}
          </p>
          ...
          <div className="csv-import-actions">
            ...
            <button className="btn btn-primary" onClick={handleImport}>
              Import {mappedTrades.length} Trade
              {mappedTrades.length !== 1 ? "s" : ""}
            </button>
          </div>
        </div>
      )}
