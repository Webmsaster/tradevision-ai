...
const sampleTrades: Trade[] = [
  makeTrade({ id: '1', pair: 'BTC/USDT', pnl: 2000, pnlPercent: 5, exitDate: '2026-01-02T00:00:00Z' }),
  makeTrade({ id: '2', pair: 'ETH/USDT', pnl: -500, pnlPercent: -2.5, direction: 'short', exitDate: '2026-01-03T00:00:00Z' }),
  makeTrade({ id: '3', pair: 'SOL/USDT', pnl: 300, pnlPercent: 1.2, exitDate: '2026-01-01T00:00:00Z' }),
];
...
describe('TradeTable', () => {
  ...
  it('sorts by pair when clicking Pair header', () => {
    render(<TradeTable trades={sampleTrades} />);
  ...
  it('shows pagination when more than 25 trades', () => {
    const manyTrades = Array.from({ length: 30 }, (_, i) =>
      makeTrade({ id: String(i), pair: `PAIR${i}/USDT`, exitDate: `2026-01-${String(i + 1).padStart(2, '0')}T00:00:00Z` })
    );
