...
describe('autoDetectMapping', () => {
  it('maps standard column names', () => {
    const headers = ['pair', 'direction', 'entry_price', 'exit_price', 'quantity', 'entry_date', 'exit_date', 'fees', 'leverage'];
  ...
  it('maps alternative column names', () => {
    const headers = ['symbol', 'side', 'open_price', 'close_price', 'amount', 'date', 'commission'];
    const mapping = autoDetectMapping(headers);
  ...
  it('is case insensitive', () => {
    const headers = ['PAIR', 'Direction', 'Entry_Price', 'EXIT_PRICE', 'Quantity'];
    const mapping = autoDetectMapping(headers);
...
describe('mapCSVToTrades', () => {
  ...
  it('filters out rows with missing essential fields', () => {
    const data = [
      { 'Pair': '', 'Direction': 'long', 'Entry Price': '100', 'Exit Price': '110', 'Quantity': '1' },
      { 'Pair': 'BTC/USDT', 'Direction': 'long', 'Entry Price': 'abc', 'Exit Price': '110', 'Quantity': '1' },
      { 'Pair': 'BTC/USDT', 'Direction': 'long', 'Entry Price': '100', 'Exit Price': '110', 'Quantity': '1' },
    ];
  ...
  it('defaults direction to long for unknown values', () => {
    const data = [
      { 'Pair': 'BTC/USDT', 'Direction': 'unknown', 'Entry Price': '100', 'Exit Price': '110', 'Quantity': '1', 'Entry Date': '', 'Exit Date': '', 'Fees': '', 'Leverage': '' },
    ];
  ...
  it('maps sell/buy to short/long', () => {
    const data = [
      { 'Pair': 'ETH/USDT', 'Direction': 'sell', 'Entry Price': '100', 'Exit Price': '90', 'Quantity': '1', 'Entry Date': '', 'Exit Date': '', 'Fees': '', 'Leverage': '' },
      { 'Pair': 'ETH/USDT', 'Direction': 'buy', 'Entry Price': '100', 'Exit Price': '110', 'Quantity': '1', 'Entry Date': '', 'Exit Date': '', 'Fees': '', 'Leverage': '' },
    ];
...
describe('PLATFORM_PRESETS', () => {
  ...
  it('each preset has all required fields', () => {
    const requiredFields = ['pair', 'direction', 'entryPrice', 'exitPrice', 'quantity', 'entryDate', 'exitDate'];
