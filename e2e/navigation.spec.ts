...
test.describe("Navigation", () => {
  ...
  test("should load the dashboard page", async ({ page }) => {
    await gotoAndWaitForApp(page, "/");
    const heading = page
      .locator(".dashboard-title, .dashboard-empty-title")
      .first();
  ...
  test("should navigate to the Analytics page via sidebar", async ({
    page,
  }) => {
    await gotoAndWaitForApp(page, "/");
  ...
  test("should navigate to the AI Insights page via sidebar", async ({
    page,
  }) => {
    await gotoAndWaitForApp(page, "/");
  ...
  test("should navigate to the Calculator page via sidebar", async ({
    page,
  }) => {
    await gotoAndWaitForApp(page, "/");
